...
class InfoPane:
  ...
  def drawPane(self):
    self.scoreText = text( self.toScreen(0, 0  ), self.textColor, self._infoString(0,3000), "Consolas", self.fontSize, "bold")
    self.redText = text( self.toScreen(650, 0  ), TEAM_COLORS[0], self._redScoreString(), "Consolas", self.fontSize, "bold")
    self.redText = text( self.toScreen(1050, 0  ), TEAM_COLORS[1], self._blueScoreString(), "Consolas", self.fontSize, "bold")
